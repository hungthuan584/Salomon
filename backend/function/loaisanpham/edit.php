            ...
            <!-- content -->
                ...
                <form action="" method="post" name="frmLoaiSanPham" id="frmLoaiSanPham">
                  <div class="form-group">
                    ...
                    <input type="text" name="lsp_ten" id="lsp_ten" class="form-control" placeholder="Nhập tên loại sản phẩm" value="<?= $loaisanphamRow['lsp_ten']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="">Mô tả</label> <br>
                    <textarea name="lsp_mota" id="lsp_mota" cols="30" rows="10" class="form-control" placeholder="Nhập mô tả loại sản phẩm"> <?= $loaisanphamRow['lsp_mota']; ?> </textarea>
                  </div>
